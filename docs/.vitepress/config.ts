        ...
        '/': [
          {
            ...
            items: [
              ...
              { text: 'v0.108.0 Recap', link: '/releases/v0.108.0' },
              { text: 'v0.107.0 Recap', link: '/releases/v0.107.0' },
              { text: 'v0.106.0 Recap', link: '/releases/v0.106.0' },
              { text: 'v0.105.0 Recap', link: '/releases/v0.105.0' },
              { text: 'v0.104.0 Recap', link: '/releases/v0.104.0' },
              { text: 'v0.103.0 Recap', link: '/releases/v0.103.0' },
              { text: 'v0.102.0 Recap', link: '/releases/v0.102.0' },
              { text: 'v0.101.0 Recap', link: '/releases/v0.101.0' },
              { text: 'v0.100.0 Recap', link: '/releases/v0.100.0' },
              { text: 'v0.99.0 Recap', link: '/releases/v0.99.0' },
              { text: 'v0.98.0 Recap', link: '/releases/v0.98.0' },
              { text: 'v0.97.0 Recap', link: '/releases/v0.97.0' },
              { text: 'v0.96.0 Recap', link: '/releases/v0.96.0' },
              { text: 'v0.95.0 Recap', link: '/releases/v0.95.0' },
              { text: 'v0.94.0 Recap', link: '/releases/v0.94.0' },
              { text: 'v0.93.0 Recap', link: '/releases/v0.93.0' },
              { text: 'v0.92.0 Recap', link: '/releases/v0.92.0' },
              { text: 'v0.91.0 Recap', link: '/releases/v0.91.0' },
              { text: 'v0.90.0 Recap', link: '/releases/v0.90.0' },
              { text: 'v0.89.0 Recap', link: '/releases/v0.89.0' },
              { text: 'v0.88.0 Recap', link: '/releases/v0.88.0' },
              ...
              { text: 'v0.83.0 Recap', link: '/releases/v0.83.0' },
              { text: 'v0.82.0 Recap', link: '/releases/v0.82.0' },
              { text: 'v0.81.0 Recap', link: '/releases/v0.81.0' },
              { text: 'v0.80.0 Recap', link: '/releases/v0.80.0' },
              { text: 'v0.79.0 Recap', link: '/releases/v0.79.0' },
              { text: 'v0.78.0 Recap', link: '/releases/v0.78.0' },
              { text: 'v0.77.0 Recap', link: '/releases/v0.77.0' },
              { text: 'v0.76.0 Recap', link: '/releases/v0.76.0' },
              { text: 'v0.75.0 Recap', link: '/releases/v0.75.0' },
              { text: 'v0.74.0 Recap', link: '/releases/v0.74.0' },
              { text: 'v0.73.0 Recap', link: '/releases/v0.73.0' },
              { text: 'v0.72.0 Recap', link: '/releases/v0.72.0' },
              { text: 'v0.71.0 Recap', link: '/releases/v0.71.0' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Published Schemas', link: '/api/schemas' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Ranking Baseline Retention', link: '/deployment/ranking-baseline-retention-cookbook' },
