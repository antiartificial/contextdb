...
| Acquisition connector retry receipts | Implemented | v0.107 | `active-learning`, `audit`, `reliability` | Executed connector attempts record receipts, idempotency keys, retry classification, retry candidates, and backoff recommendations |
